...
class LearnerServicer(metaclass=abc.ABCMeta):
    ...
    def Train(
        ...
        collections.abc.Iterator[learner_pb2.StatusMessage],
        collections.abc.AsyncIterator[learner_pb2.StatusMessage],
    ]: ...
    @abc.abstractmethod
    def Predict(
        self,
        ...
        learner_pb2.Prediction,
        collections.abc.Awaitable[learner_pb2.Prediction],
    ]: ...
    @abc.abstractmethod
    def Export(
        self,
        ...
        learner_pb2.Empty, collections.abc.Awaitable[learner_pb2.Empty]
    ]: ...

def add_LearnerServicer_to_server(
