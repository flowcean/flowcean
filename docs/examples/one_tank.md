...
For this example the [`MeanAbsoluteError`](../reference/flowcean/sklearn/index.md#flowcean.sklearn.MeanAbsoluteError), [`MeanSquaredError`](../reference/flowcean/sklearn/index.md#flowcean.sklearn.MeanSquaredError) and [`MaxError`](../reference/flowcean/sklear/index.md#flowcean.sklearn.MaxError) error are used.
