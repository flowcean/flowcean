...
Which learners are implemented in Flowcean can be found [here](../reference/index.md#learners-and-models).
...
For more information take a look at the [API](../reference/core.md#flowcean.core.Model).
