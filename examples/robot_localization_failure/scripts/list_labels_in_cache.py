...
"""
list_labels_in_cache.py

Scans a directory of cached PyTorch (.pt) files and summarizes label
distribution. Supports common formats like (image, label) tuples,
dicts with 'label', or scalar tensors. Prints class counts, examples,
and optional CSV output for further analysis.

Usage:
    python list_labels_in_cache.py --cache learning_cache/ [--csv labels.csv]

Example output:
    Scanned 12000 files in: learning_cache
      Label 0.0 (localized):   8400
      Label 1.0 (delocalized): 3600
      Other/unknown:           0
      Read errors:             0

    Class ratio (pos=1.0): 0.300  (3600 / 12000)

    Examples with label 0.0 (showing up to 30):
       000001.pt
       000002.pt
       000003.pt
       ...

    Examples with label 1.0 (showing up to 30):
       005678.pt
       005679.pt
       005680.pt
       ...

    Wrote CSV: labels.csv
"""
