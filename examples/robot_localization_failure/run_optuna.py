...
def objective(trial, train_data, eval_data, config):
...
def main() -> None:
    ...
    study.optimize(
        partial(objective, train_data=samples_train, eval_data=samples_eval, config=config),
        n_trials=2,
    )
