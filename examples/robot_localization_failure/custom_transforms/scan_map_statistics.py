...
flowcean/examples/robot_localization_failure on  flowcean_ml_pipeline [$13!2?4] is 📦 v0.1.0 via 🐍 v3.12.8 (flowcean) 
❯ python3 -m ml_pipeline.dataset.build_dataset

📦 Processing 1 training bag(s)...
 → Training bag: recordings/rec_20250923_135805_id_01

=== Processing bag: recordings/rec_20250923_135805_id_01 ===
Loading topic '/particle_cloud': 100%|█████████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 5/5 [00:12<00:00,  2.45s/it]
2025-11-25 14:04:59,444 [flowcean.ros.rosbag][INFO] Caching ROS data to Parquet file...                                                                                                  
Precomputing poses: 100%|████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 1259/1259 [00:00<00:00, 138559.18it/s]
Computing scan points: 100%|████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 1804/1804 [00:05<00:00, 334.96it/s]
Detecting lines: 100%|███████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 18/18 [00:00<00:00, 226040.34it/s]
Detecting lines: 100%|███████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 20/20 [00:00<00:00, 367921.40it/s]
Computing scan-map features: 100%|███████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 1772/1772 [00:18<00:00, 94.86it/s]
Processing particle cloud messages: 100%|████████████████████████████████████████████████████████████████████████████████████████████████████████████| 1259/1259 [01:14<00:00, 16.87it/s]
> /home/markus/ros2_ws/src/flowcean/examples/robot_localization_failure/ml_pipeline/dataset/bag_processor.py(68)process_single_bag()
-> scan_ts = full_df["/scan"][0]
(Pdb) from flowcean.polars.transforms.zero_order_hold_matching import ZeroOrderHold
(Pdb)     zoh_transform = ZeroOrderHold( reference_column="/scan", drop=True)
(Pdb)     zoh_df = zoh_transform(full_df).collect()
2025-11-25 14:09:35,177 [flowcean.polars.transforms.zero_order_hold_matching][INFO] No features specified for ZOH alignment; using all features
*** polars.exceptions.InvalidOperationError: prefix_fields operation not supported for dtype `list[list[f64]]` (expected: Struct)
(Pdb) full_df.schema
Schema({'/amcl_pose': List(Struct({'time': Int64, 'value': Struct({'pose.pose.position.x': Float64, 'pose.pose.position.y': Float64, 'pose.pose.orientation.x': Float64, 'pose.pose.orientation.y': Float64, 'pose.pose.orientation.z': Float64, 'pose.pose.orientation.w': Float64})})), '/momo/pose': List(Struct({'time': Int64, 'value': Struct({'pose.position.x': Float64, 'pose.position.y': Float64, 'pose.orientation.x': Float64, 'pose.orientation.y': Float64, 'pose.orientation.z': Float64, 'pose.orientation.w': Float64})})), '/scan': List(Struct({'time': Int64, 'value': Struct({'ranges': List(Float64), 'angle_min': Float64, 'angle_max': Float64, 'angle_increment': Float64, 'range_min': Float64, 'range_max': Float64})})), '/map': List(Struct({'time': Int64, 'value': Struct({'data': List(Int64), 'info.resolution': Float64, 'info.width': Int64, 'info.height': Int64, 'info.origin.position.x': Float64, 'info.origin.position.y': Float64, 'info.origin.position.z': Float64, 'info.origin.orientation.x': Float64, 'info.origin.orientation.y': Float64, 'info.origin.orientation.z': Float64, 'info.origin.orientation.w': Float64})})), '/particle_cloud': List(Struct({'time': Int64, 'value': Struct({'particles': List(Struct({'pose': Struct({'position': Struct({'x': Float64, 'y': Float64, 'z': Float64}), 'orientation': Struct({'x': Float64, 'y': Float64, 'z': Float64, 'w': Float64})}), 'weight': Float64}))})})), 'scan_points': List(Struct({'time': Int64, 'value': List(List(Float64))})), 'scan_points_sensor': List(Struct({'time': Int64, 'value': List(List(Float64))})), 'point_distance': List(Struct({'time': Int64, 'value': Float64})), 'point_fitting': List(Struct({'time': Int64, 'value': Float64})), 'point_inlier': List(Struct({'time': Int64, 'value': Float64})), 'point_quality': List(Struct({'time': Int64, 'value': Float64})), 'ray_inlier': List(Struct({'time': Int64, 'value': Float64})), 'ray_inlier_percent': List(Struct({'time': Int64, 'value': Float64})), 'ray_matching_percent': List(Struct({'time': Int64, 'value': Float64})), 'ray_outlier_percent': List(Struct({'time': Int64, 'value': Float64})), 'ray_quality': List(Struct({'time': Int64, 'value': Float64})), 'angle_inlier': List(Struct({'time': Int64, 'value': Float64})), 'angle_quality': List(Struct({'time': Int64, 'value': Float64})), 'line_angle': List(Struct({'time': Int64, 'value': Float64})), 'line_distance': List(Struct({'time': Int64, 'value': Float64})), 'line_fitting': List(Struct({'time': Int64, 'value': Float64})), 'line_length': List(Struct({'time': Int64, 'value': Float64})), 'cog_max_distance': List(Struct({'time': Int64, 'value': Float64})), 'cog_mean_dist': List(Struct({'time': Int64, 'value': Float64})), 'cog_mean_absolute_deviation': List(Struct({'time': Int64, 'value': Float64})), 'cog_median': List(Struct({'time': Int64, 'value': Float64})), 'cog_median_absolute_deviation': List(Struct({'time': Int64, 'value': Float64})), 'cog_min_distance': List(Struct({'time': Int64, 'value': Float64})), 'cog_standard_deviation': List(Struct({'time': Int64, 'value': Float64})), 'circle_radius': List(Struct({'time': Int64, 'value': Float64})), 'circle_mean': List(Struct({'time': Int64, 'value': Float64})), 'circle_mean_absolute_deviation': List(Struct({'time': Int64, 'value': Float64})), 'circle_median': List(Struct({'time': Int64, 'value': Float64})), 'circle_median_absolute_deviation': List(Struct({'time': Int64, 'value': Float64})), 'circle_min_distance': List(Struct({'time': Int64, 'value': Float64})), 'circle_standard_deviation': List(Struct({'time': Int64, 'value': Float64})), 'num_clusters': List(Struct({'time': Int64, 'value': Int64})), 'main_cluster_variance_x': List(Struct({'time': Int64, 'value': Float64})), 'main_cluster_variance_y': List(Struct({'time': Int64, 'value': Float64}))})
(Pdb) 
